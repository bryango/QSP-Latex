...
\begin{center}
\includegraphics[width = 10cm]{../fig/2-6-1.png}\label{Fig2.6.1}
\end{center}
...
\begin{center} \includegraphics[width=8cm]{../fig/2-6-2.png} \label{Fig2.6.2}\end{center}
where these bold lines themselves are given by this proper selfenergy via Dyson equation,
\begin{center} \includegraphics[width=6cm]{../fig/2-6-3.png}\label{Fig2.6.3} \end{center}
...
\begin{center} \label{Fig2.7.1} \includegraphics[width=6cm]{../fig/2-7-1.png}
\end{center}
...
\begin{center} \label{Fig2.7.2} \includegraphics[width=3cm]{../fig/2-7-2.png} \end{center}
...
\begin{center}\label{Fig2.7.3} \includegraphics[width=8cm]{../fig/2-7-3.png} \end{center}

For the uniform electron gas case, these four term exactly reduce to zero.
\begin{center}-----------------------------\end{center}

\begin{wrapfigure}{l}{3.5cm}
\label{Fig2.7.4} \includegraphics[width=3cm]{../fig/2-7-4.png}
\end{wrapfigure}
...
\label{Fig2.7.5} \includegraphics[width=4cm]{../fig/2-7-5.png}
\end{wrapfigure}
...
\label{Fig2.7.6} \includegraphics[width=3cm]{../fig/2-7-6.png}
\end{wrapfigure}
...
\begin{wrapfigure}[4]{l}{3.5cm}
\label{Fig2.7.7} \includegraphics[width=3cm]{../fig/2-7-7.png}
\end{wrapfigure}
...
%\begin{wrapfigure}{l}{3.5cm}
%\label{Fig2.7.8} \includegraphics[width=3cm]{../fig/2-7-8.png}
%\end{wrapfigure}
\begin{center}---------------------------------------------\end{center}
...
\begin{center}
\includegraphics[width=8cm]{../fig/2-7-9.png}\label{Fig2.7.9}
...
\label{Fig2.7.10} \includegraphics[width=3cm]{../fig/2-7-10.png}
\end{wrapfigure}
...
\begin{center}
\label{Fig2.7.11} \includegraphics[width=6cm]{../fig/2-7-11.png}
\end{center}
...
\begin{center}
\label{Fig2.7.12} \includegraphics[width=6cm]{../fig/2-7-12.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{../fig/2-7-13.png}\label{Fig2.7.13}
\end{center}

These ladder-type of diagram can be given by so-called the effective two-particle interaction.
\begin{center}
\includegraphics[width=0.55\textwidth]{../fig/2-7-13'.png}\label{Fig2.7.13'}
\begin{equation} \label{Eqs2.7.4}\end{equation}
\end{center}

Where the effective two-particle interaction is given by this:
\begin{center}
\includegraphics[width=0.6\textwidth]{../fig/2-7-14.png}\label{Fig2.7.14}
...
\begin{center} \includegraphics[width=0.5\textwidth]{../fig/2-7-15.png} \label{Fig2.7.15} \end{center}
...
\includegraphics[width=0.3\textwidth]{../fig/2-8-1.png}
\end{center}
...
\includegraphics[width=0.3\textwidth]{../fig/2-8-2.png}
\end{center}
...
\includegraphics[width=0.3\textwidth]{../fig/2-8-5.png}
\end{center}
...
\includegraphics[width=0.3\textwidth]{../fig/2-8-6.png}
\end{center}
...
One is {\label{Fig2.8.7} \includegraphics[width=0.05\textwidth]{../fig/2-8-7.png}} and the other is {\label{Fig2.8.8} \includegraphics[width=0.05\textwidth]{../fig/2-8-8.png}}.
...
\includegraphics[width=0.3\textwidth]{../fig/2-8-9.png}
\end{center}
...
\includegraphics[width=0.15\textwidth]{../fig/2-8-10.png}
\end{center}
...
\includegraphics[width=0.6\textwidth]{../fig/2-8-11.png}
\end{center}
...
\includegraphics[width=0.8\textwidth]{../fig/2-8-12.png}
\end{center}
...
\includegraphics[width=0.8\textwidth]{../fig/2-8-13.png}
\end{center}
...
\includegraphics[width=0.6\textwidth]{../fig/2-8-14.png}
\end{center}}
...
where
\begin{itemize}
\item \[\Pi_0^\bigstar(q)= \includegraphics[width=0.1\textwidth]{../fig/2-8-15.png}\quad(\equiv \Pi_0(q))\]

\item \[\Pi_1^\bigstar(q) = \includegraphics[width=0.4\textwidth]{../fig/2-8-16.png} \]
...
\includegraphics[width=0.6\textwidth]{../fig/2-8-17.png}
\end{center}
...
\includegraphics[width=0.6\textwidth]{../fig/2-8-20.png}
\end{center}
\begin{itemize}
...
\includegraphics[width=0.17\textwidth]{../fig/2-8-21.png}
\end{center}
\begin{itemize}
...
\includegraphics[width=0.2\textwidth]{../fig/2-8-22.png}
\end{center}
\begin{itemize}
...
\includegraphics[width=0.35\textwidth]{../fig/2-8-23.png}
\end{center}
...
\includegraphics[width=0.17\textwidth]{../fig/2-8-24.png}
\end{center}
...
\includegraphics[width=0.6\textwidth]{../fig/2-8-25.png}
\end{center}
...
\includegraphics[width=0.6\textwidth]{../fig/2-8-26.png}
\end{center}
...
\includegraphics[width=0.6\textwidth]{../fig/2-8-27.png}
\end{center}
...
\includegraphics[width=0.6\textwidth]{../fig/2-8-28.png}
\end{center}
...
\includegraphics[width=0.6\textwidth]{../fig/2-8-29.png}
\end{center}
\item For $2 < q$ case:
\begin{center}\label{Fig2.8.30}
\includegraphics[width=0.6\textwidth]{../fig/2-8-30.png}
\end{center}
\end{itemize}
...
\includegraphics[width=0.6\textwidth]{../fig/2-8-31.png}
\end{center}
...
Moreover, when it comes to the 3rd-order term\includegraphics[width=0.15\textwidth]{../fig/2-8-32.png}, the integrand contains $V_0^3(q) (\Pi^0(q))^3$, so that this momentum integral in the infrared regime will be replaced by the following form.
...
\includegraphics[width=0.6\textwidth]{../fig/2-8-33.png}
\end{center}
\begin{equation*} \tag{2.8.9}
...
\includegraphics[width=0.3\textwidth]{../fig/3-1-1.png}
\end{center}
...
\includegraphics[width=0.22\textwidth]{../fig/3-1-2.png}
\end{center}
...
\includegraphics[width=0.6\textwidth]{../fig/3-1-3.png}
\end{center}
...
\includegraphics[width=0.4\textwidth]{../fig/3-1-4.png}
\end{center}
...
\includegraphics[width=0.22\textwidth]{../fig/3-1-5.png}
\end{center}
...
\includegraphics[width=0.3\textwidth]{../fig/3-1-6.png}
\end{center}
...
\includegraphics[width=0.2\textwidth]{../fig/3-1-7.png}
\end{center}
...
\includegraphics[width=0.6\textwidth]{../fig/3-1-8.png}
\end{center}
