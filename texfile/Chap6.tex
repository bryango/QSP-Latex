...
\begin{figure}
\begin{center}
\includegraphics[width = 8cm]{../fig/6-1.png}\label{Fig6.1}\includegraphics[width = 8cm]{../fig/6-2.png}\label{Fig6.2}
...
\includegraphics[width = 4.5cm]{../fig/6-3.png}\
\end{wrapfigure}
...
\begin{wrapfigure}{l}{6cm}
\includegraphics[width = 4.5cm]{../fig/6-l2.png}
\includegraphics[width = 4.5cm]{../fig/6-l1.png}
\end{wrapfigure}
