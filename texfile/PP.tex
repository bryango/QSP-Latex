...
$$
\begin{center}
\includegraphics[width=5cm]{../fig/fig4-3-1.png}
\end{center}
...
%p659
\begin{center}
\includegraphics[height=22cm]{../fig/fig4-3-2.png}
\end{center}
%p660
...
Assign a non-interacting temperature Green's function $g_{\alpha\beta}^0(1,2)$ for each directed solid lines. \includegraphics[height=0.7cm]{../fig/fig4-4-1.png}
Assign a factor $V(\mathbf{x}_1-\mathbf{x}_2)\delta(\tau_1-\tau_2)$ for each interaction line.\\
\includegraphics[height=1cm]{../fig/fig4-4-2.png}
...
\begin{center}
\includegraphics[height=3cm]{../fig/fig4-4-3.png}
\end{center}
%p668
...
\begin{center}
\includegraphics[height=3cm]{../fig/fig4-4-4.png}
\end{center}
$$
\left\{
\begin{aligned}
...
%p680
When a particle line closes on itself \includegraphics[height=0.7cm]{../fig/fig4-4-5.png} or a particle line joined by the same interaction line\includegraphics[height=1cm]{../fig/fig4-4-6.png}, assign a convergence factor $e^{i\omega_m\eta}$ for particle line.\\
\rule{\textwidth}{1mm}
...
\begin{center}
\includegraphics[height=3cm]{../fig/fig4-4-7.png}
\end{center}
\begin{equation}
\begin{aligned}
...
\]
\begin{center}
\includegraphics[height=4cm]{../fig/fig4-4-8.png}
\end{center}
...
%p685
\begin{center}
\includegraphics[height=4cm]{../fig/fig4-4-9.png}
\end{center}
\[
\begin{aligned}
...
\begin{center}
\includegraphics[height=4cm]{../fig/fig4-4-10.png}
\end{center}
Now that the integrand has a pole only on the real axis, we can deform in this way
\begin{center}
\includegraphics[height=4cm]{../fig/fig4-4-11.png}
\end{center}
%p689
...
\begin{center}
\includegraphics[height=2cm]{../fig/fig4-5-1.png}
\end{center}
%p695
...
\begin{center}
\includegraphics[height=2cm]{../fig/fig4-5-2.png}
\end{center}
...
\begin{center}
\includegraphics[width=\textwidth]{../fig/fig4-7-1.png}
\end{center}
%p757
\begin{center}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{../fig/fig4-8-1.jpg}
\end{center}
 Once the system is sufficiently equilibrated, we isolate the system from the bath.
%p763
\begin{center}
\includegraphics[width=0.8\textwidth]{../fig/fig4-8-2.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{../fig/fig4-8-3.jpg}
\end{center}
...
%782
\includegraphics[width=\textwidth]{../fig/fig4-8-4.jpg}
%783
...
\includegraphics[width=0.5\textwidth]{../fig/fig4-9-1.png}\\
 For example, for the second order in the interaction potential, we have following two Feynman diagrams.\\
\includegraphics[width=\textwidth]{../fig/fig4-9-2.png}\\
Since the one of the two interaction potential \includegraphics[width=1cm]{../fig/fig4-9-3.png} is disconnected from these four external points, we call this type of diagram
%p797
...
\includegraphics[width=0.8\textwidth]{../fig/fig4-9-4.jpg}
%p802
...
\includegraphics[width=0.5\textwidth]{../fig/fig4-9-5.jpg}
...
%p805
\includegraphics[width=0.8\textwidth]{../fig/fig4-9-6.jpg}
...
\includegraphics[width=\textwidth]{../fig/fig4-9-7.jpg}\\
...
\]
\includegraphics[width=\textwidth]{../fig/fig4-9-8.jpg}
...
\includegraphics[width=0.4\textwidth]{../fig/fig4-9-9}\\
\[
\begin{aligned}
