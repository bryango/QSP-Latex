...
\begin{figure}[h]
\includegraphics[width = 10cm]{../fig/1-1.png}
\end{figure}

An example of the system is a drumhead vibration. Here is a picture of drum:

\begin{figure}[h]
\includegraphics[width = 8cm]{../fig/1-2.png}
\end{figure}
...
\includegraphics[width = 4.5cm]{../fig/1-3.png}
\end{wrapfigure}
...
\includegraphics[width = 4.6cm]{../fig/1-4.png}
\end{wrapfigure}
